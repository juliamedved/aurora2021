...
import Walking from "../ai/steerings/walking";
import Overtake from "../ai/steerings/overtake";
...
export default class CharacterFactory {
  ...
  getSteerings(params, owner){
    switch(params.steering){
      case "walking": 
        return new Walking(owner, params.target);
      case "overtake":
        return new Overtake(owner, params.target);
      default:
        return null;
    }
  }
